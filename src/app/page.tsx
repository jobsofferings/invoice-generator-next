...
export default function InvoiceGenerator() {
  ...
  return (
    <div className="min-h-screen flex flex-col container mx-auto pt-24 items-center">
      <div className="w-11/12 flex flex-col items-center bg-muted/20 p-4 px-2 rounded-md shadow-md">
      ...
      <div className="bg-muted/20 rounded-md w-11/12 mt-4 p-4 flex flex-col gap-6">
          ...
          >
            ...
            <SelectContent className="font-semibold text-lg">
              ...
              <SelectItem value="custom">
                Custom{" "}
                <span className="text-purple-500">- Define Your Own Type</span>
              </SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        {invoice.type == "custom" && (
          <div className="grid w-full max-w-sm items-center bg-muted/20 p-2 rounded-md border-2">
            <Label
              htmlFor="customType"
              className="text-purple-500 font-semibold text-start"
            >
        ...
        <div className="grid w-full max-w-sm items-center bg-muted/20 p-4 rounded-md">
          <Label
            htmlFor="items"
          ...
          {invoice.items.map((item, index) => (
            <div key={index} className="grid gap-1.5 p-2 shadow-md border mt-4">
              <Label
                htmlFor={`item-${index}`}
              ...
              <div className="grid w-full max-w-sm items-center p-2 rounded-md border-2">
                <Label
        ...
        {/* Subtotal */}
        <div className="max-w-sm flex justify-between p-2 font-bold text-lg bg-muted/20 border rounded-md">
          <div>Subtotal</div>
        ...
        <div className="flex flex-col bg-muted/20 p-2 rounded-md shadow-md border max-w-sm">
          <Label className="text-purple-500 font-semibold text-center mt-2">
            Additional Variables
          </Label>

          <div className="flex justify-between gap-2 items-center align-middle mt-4">
            ...
            {invoice.discount == undefined ? (
              ...
              <button
                type="button"
                className="bg-red-500/20 border border-red-500 text-red-500 font-semibold p-2 rounded-md w-full shadow-md"
                onClick={() => setInvoice({ ...invoice, discount: undefined })}
              >
                - Discount
              </button>
            )}
            ...
            {invoice.shipping == undefined ? (
              ...
              <button
                type="button"
                className="bg-red-500/20 border border-red-500 text-red-500 font-semibold p-2 rounded-md w-full shadow-md"
                onClick={() => setInvoice({ ...invoice, shipping: undefined })}
              >
                - Shipping
              </button>
            )}
          ...
          {invoice.tax != undefined && (
            <div className="grid w-full max-w-sm items-center bg-muted/20 p-2 rounded-md border-2 mt-4">
        ...
        <button 
          className="bg-purple-500 text-white font-semibold p-2 rounded-md max-w-sm shadow-md mt-4"
